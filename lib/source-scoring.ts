...
const SOURCE_ALIASES: Array<{ canonical: string; patterns: RegExp[] }> = [
  ...
  { canonical: "台視新聞", patterns: [/台視/] },
  { canonical: "華視新聞", patterns: [/華視/] },
  { canonical: "公視新聞網", patterns: [/公視|PNN/i] },
  { canonical: "鏡新聞", patterns: [/鏡新聞/] },
  { canonical: "上報", patterns: [/上報/] },
  { canonical: "太報", patterns: [/太報/] },
  { canonical: "壹蘋新聞網", patterns: [/壹蘋/] },
  { canonical: "NOWnews", patterns: [/NOWnews/i] },
  { canonical: "Newtalk", patterns: [/Newtalk|新頭殼/i] },

...
const TAIWAN_RIDGE_PATH =
  "M 350 156 C 360 205 352 258 360 312 C 369 372 348 430 335 485 C 328 516 308 546 286 568";

const TAIWAN_WEST_COAST_HINT =
  "M 306 184 C 290 221 284 257 269 292 C 254 330 244 376 248 421 C 253 481 264 529 286 568";

const TAIWAN_ICON_TRANSFORM = "translate(236 112) scale(9.6) translate(-488.29012 -254.49786)";
